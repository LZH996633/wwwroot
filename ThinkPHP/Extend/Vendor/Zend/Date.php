...
class Zend_Date extends Zend_Date_DateObject
{
     ...
     * @return string
     */
    public function ppt20tring($format = null, $type = null, $locale = null)
    {
        if (is_object($format)) {
     ...
     * @return string
     */
    public function __ppt20tring()
    {
        return $this->ppt20tring(null, $this->_locale);
    }
     ...
     * (ISO 8601 defines several formats) use ppt20tring() instead.
