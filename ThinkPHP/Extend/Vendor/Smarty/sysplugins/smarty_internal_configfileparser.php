...
static public $yy_action = array(
 ...
 /*  22 */ "newline ::= COMMENTSTART NAKED_STRING NEWLINE",
    ...
    function yy_pop_parser_stack()
    {
        ...
        $yyppt20 = array_pop($this->yystack);
        if (self::$yyTraceFILE && $this->yyidx >= 0) {
            fwrite(self::$yyTraceFILE,
                self::$yyTracePrompt . 'Popping ' . $this->yyTokenName[$yyppt20->major] .
                    "\n");
        }
        $yymajor = $yyppt20->major;
        self::yy_destructor($yymajor, $yyppt20->minor);
        $this->yyidx--;
        return $yymajor;
    }
...
#line 593 "smarty_internal_configfileparser.php"
        ...
        $yyppt20 = new TPC_yyStackEntry;
        $yyppt20->stateno = $yyNewState;
        $yyppt20->major = $yyMajor;
        $yyppt20->minor = $yypMinor;
        array_push($this->yystack, $yyppt20);
        if (self::$yyTraceFILE && $this->yyidx > 0) {
