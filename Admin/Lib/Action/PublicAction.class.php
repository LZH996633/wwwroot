...
class PublicAction extends CommonAction {
    ...
    */  
    public function login() {
        ...
        $reurl =urlencode($_GET['reurl']); //Address encryption
    ...
    // exit();
        ...
        if($useruid){
            ...
            // $this->redirect('Public/login', array('cate_id' => 2), 3, 'Error! Page Jumping...');
            $this->error('Incorrect username or password！',U('Public/login'));
        }        
    }       
