...
<body>
    ...
    <table class="imgtable">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <!--<td><?php if($vo["opus_power"] == 1 ): ?>Ordinary member<?php elseif($vo["opus_power"] == 2): ?>VIP会员<?php else: ?> Senior VIP member<?php endif; ?></td>-->
            <!--<td><?php if($vo["opus_verify"] == 1): ?>Audited<?php else: ?>Unreviewed<?php endif; ?></td>-->
            <td><p>Gold：<?php echo ($vo["price"]); ?></p><!--<p>积分：<?php echo ($vo["scoreprice"]); ?></p>--></td>
            <td><p><?php if($vo["is_half"] == 0): ?>No<?php else: ?>Yes<?php endif; ?></p></td>
            <td><p>Yes：<?php echo ($vo["oext_views"]); ?></p><p>Number of collections：<?php echo ($vo["oext_favorite"]); ?></p><p>Number of transactions：<?php echo ($vo["oext_trade"]); ?></p></td>
            <td>
...
<!--
                <?php if($vo["opus_verify"] == 1): else: ?>
                    <?php if($vo["opus_verify"] == 2): ?><a href="<?php echo U('Opus/uncheck','id='.$vo['opus_id']);?>" class="tablelink"><?php echo ($repeat); echo ($repeat); ?>退回</a><?php else: ?><a href="<?php echo U('Opus/check','id='.$vo['opus_id']);?>" class="tablelink"><?php echo ($repeat); echo ($repeat); ?>通过审核</a><?php endif; endif; ?>-->
            </td>
