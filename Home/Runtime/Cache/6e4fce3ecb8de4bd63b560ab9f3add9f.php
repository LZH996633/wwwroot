...
<script type="text/javascript">
	...
	<span class="shut" action-type="shut" action-data="nid=0&amp;name=message"></span><?php endif; ?>
		...
		<i onmouseover="display()"  onmouseout="disappear()" ><a style="color:red;" href="<?php echo U('Service/main');?>" class="active">Member Centre</a></i>
       ...
       <i onmouseover="display()"  onmouseout="disappear()" >
		<?php if($idcard_sta == 1): ?><a id="css" href="<?php echo U('Service/materialupload', array('pid'=>1));?>">Works release</a>
		<?php else: ?>
		<a href="javascript:void(0);" class="chanView" data-value="Renzhengdata">Works release</a><?php endif; ?>
	   </i>	
...
<script>
                    ...
                    <div class="zprt1">
                        ...
                        <div class="clearfix">
                          ...
                          <div class="name "><i>&nbsp;&nbsp;&nbsp;HI!&nbsp; <a href="javascript:;"
											...
											<li><span style="font-size:15px"><?php echo ($gold_coin); ?>&nbsp;Gold&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($gold_coins); ?>&nbsp;gold coins</span></li>
											
											
											</div>
                               
							   <div class="info">
							   <span><a href="javascript:void(0);" onclick="qiandao()">Sign in</a>
							   
							 
							  <?php if($user_veri == 1): ?><a href="javascript:void(0);" onclick="renzheng()">withdraw</a>
							   <?php else: ?>
							   <a href="javascript:void(0);" class="chanView" data-value="ToBeSeller">Please authenticate first</a><?php endif; ?>
							   ...
							   <div class="info">
							   <span class="welcome1">LOGO.com has been updated again <font color="red"><?php echo ($SameList1); ?></font> more material, and it can't stop at all！</span>
							   
							   <span class="welcome1">&nbsp;</span>
                                   <!-- <em>
                                        <a href="#">Ordinary member</a>
                                    </em>
                                    <p><a href="javascript:void(0);" class="chanView" data-value="ToBeSeller">Become a seller</a>
                                    </p>-->
                                </div>
                        ...
                        <div class="infos"><span>
						
						
						<!--
                                <i class="sc"><a href="javascript:void(0);" class="chanView"
                                        data-value="CollectFocus">Favorites</a>：<?php echo ($FavorCount); ?></i>
                                <i class="down"><a href="javascript:void(0);" class="chanView"
                                        data-value="Down_Upload">download</a>：<?php echo ($DownCount); ?></i>
                                <i class="mess"><a href="javascript:void(0);" class="chanView"
                                        data-value="StationMsg">news</a>：<?php echo ($msg); ?></i></span>
										
									-->	
										
					                 <!-- <i class="sc1"> <h2>Recommend designer</h2></i>
	...
	<section class="user-common-section1 user-safety">
...
<div class="user-center-inner-wrap2">
<?php if(is_array($SameList)): $i = 0; $__LIST__ = $SameList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="recommend-designer-item">
        
		
<a href="http://127.0.0.1:81/index.php/single/personal/user_id/<?php echo ($list["user_id"]); ?>.html" title="<?php echo ($list["user_nickname"]); ?>" target="_blank">
<img src="<?php echo ($list["user_pic"]); ?>"></a>
<p><span><?php echo ($list["user_fabu"]); ?></span>Works</p>
        ...
        <div class="user-center-inner-wrap1">

			                        <div class="infos"><span>
						
										
					                  <i class="sc1"> <h2>Latest Announcement</h2></i>
	...
	-->								
						...
						<span>&nbsp;</span>
						<!--
						<a href="javascript:void(0);" class="chanView" data-value="ToBeSeller">Become a seller</a>
							 <?php if($info['user_veri'] == 1): ?><a href="javascript:void(0);" onclick="renzheng()">withdraw</a>
							   <?php else: ?>
							   <a href="javascript:void(0);" class="chanView" data-value="ToBeSeller">Become a seller</a><?php endif; ?>
							   -->
						</div>
                ...
                <div class="smlb fr">
                    <ul>
                        <?php if(is_array($ad_list)): $i = 0; $__LIST__ = $ad_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($list["ad_piclink"]); ?>" target="_blank"><img src="<?php echo ($list["ad_pic"]); ?>" alt="" /></a>
                            </li><?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                    <ol>
                        <li></li>
  ...
  layer.msg(data.msg,{time:1000});
   ...
   layer.msg(data.msg,{time:1000})
    ...
    <script type="text/javascript">
        ...
        function renzheng() {
            $.getJSON('/index.php/Ajax/renzheng', '', function (data) {
                if (data.status == '0') {
                    layer.msg(data.msg, {
                        icon: 4,
                        time: 3000 //2 seconds to close (if not configured, the default is 3 seconds)
